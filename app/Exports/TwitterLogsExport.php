...
class TwitterLogsExport implements FromCollection, WithHeadings, WithEvents, WithColumnFormatting
{
    /**
    ...
    public function collection()
    {
        ...
        $twitter_logs = LogTwitter::where('twitter_id', $influencer_id)->get();

        $data = $twitter_logs->transform(function ($q) {
            return [
                'date' => $q->created_at,
