...
class TiktokLogsExport implements FromCollection, WithHeadings, WithEvents, WithColumnFormatting
{
    /**
    ...
    public function collection()
    {
        ...
        $tiktok_logs = LogTiktok::where('tiktok_id', $influencer_id)->get();

        $data = $tiktok_logs->transform(function ($q) {
            return [
                'date' => $q->created_at,
