...
class InstagramLogsExport implements FromCollection, WithHeadings, WithEvents, WithColumnFormatting
{
    /**
    ...
    public function collection()
    {
        ...
        $instagram_logs = LogInstagram::where('instagram_id', $influencer_id)->get();

        $data = $instagram_logs->transform(function ($q) {
            return [
                'date' => $q->created_at,
