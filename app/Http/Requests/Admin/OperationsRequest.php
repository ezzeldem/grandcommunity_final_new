    ...
    public function rules()
    {
        ...
        if($this->method() == 'PUT' || $this->method() == 'PATCH'){
            ...
            $rules = [
                ...
                'username'=>'required|string|max:100|unique:admins,username,'.$operation->id.',id,deleted_at,NULL',
                'email'=>'required|email|unique:admins,email,'.$operation->id.',id,deleted_at,NULL',
                'active'=>'required|integer|in:0,1',
