<div class="modal fade effect-newspaper show" id="import_excel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
     aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer" style="justify-content: space-between !important;">
                <a download="/file.xlsx" type="button" class="btn btn-warning" href="{{ asset('assets/import_files/influencersCampList.xlsx')}}"
                    > <i class="bi bi-download"></i>
                    <i class="fas fa-download"></i> Sample</a>
                <div class="btn">
                    <button type="button" id="import_excel_btn" class="btn btn-success">Save</button>
    ...
    <script>
        $(document).ready( function () {
           ...
           $('#import_excel_addInfluencer').click(function (){
            // data_url="{{route('dashboard.camp.addInfluencer.import')}}"
