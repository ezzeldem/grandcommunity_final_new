    ...
    <div class="row row-sm">
        <div class="col-xl-12">
            <div class="card mg-b-20">
                ...
                <div class="card-body">
                    {!! Form::open(['route' => ['dashboard.pages.store'],'method'=>'post','data-parsley-validate'=>'','id'=>'sub_brand_form','class'=>'create_page', 'enctype'=>'multipart/form-data']) !!}
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12 mt-3">
                        <div class="form-group mg-b-0">
                            ...
                            {!! Form::text('sub_title[0][0]',(isset($page))?$page->getTranslation('title','en'):old('sub_title.0.0'),['class' =>'form-control '.($errors->has('sub_title.0.0') ? 'parsley-error' : null),'placeholder'=> 'Enter Title']) !!}
                            @error('sub_title.0.0')
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 mt-3">
                        <div class="form-group mg-b-0">
                            ...
                            {!! Form::text('sub_title[0][1]',(isset($page))?$page->getTranslation('title','ar'):old('sub_title.0.1'),['class' =>'form-control '.($errors->has('sub_title.0.1') ? 'parsley-error' : null),'placeholder'=> 'Enter Title']) !!}
                            @error('sub_title.0.1')
                            <ul class="parsley-errors-list filled" id="parsley-id-11"><li class="parsley-required">{{$message}}</li></ul>
                            @enderror
                        </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 mt-3">
                        <div class="form-group mg-b-0">
                            ...
                            {!! Form::textarea('sub_description[0][0]',(isset($page))?$page->getTranslation('description','en'):old('sub_description.0.0'),['class' =>'form-control summernote '.($errors->has('sub_description.0.0') ? 'parsley-error' : null),'placeholder'=> 'Enter Description']) !!}
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 mt-3">
                        <div class="form-group mg-b-0">
                            ...
                            {!! Form::textarea('sub_description[0][1]',(isset($page))?$page->getTranslation('description','ar'):old('sub_description.0.1'),['class' =>'form-control summernote '.($errors->has('sub_description.0.1') ? 'parsley-error' : null),'placeholder'=> 'Enter Description']) !!}
                ...
                <div id="remove_section_${i}"  class="col-lg-12 col-md-12 col-sm-12 mt-3">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 mt-3">
                            <div class="form-group mg-b-0">
                                <label class="form-label">Title (En): <span class="tx-danger">*</span></label>
                                {!! Form::text('sub_title[${i}][0]',old('sub_title.${i}.0'),['class' =>'form-control '.($errors->has('sub_title.${i}.0') ? 'parsley-error' : null),'placeholder'=> 'Enter Title']) !!}
                                @error('sub_title.${i}.0')
                                    <ul class="parsley-errors-list filled" id="parsley-id-11">
                                        <li class="parsley-required">
                                            {{$message}}
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 mt-3">
                            <div class="form-group mg-b-0">
                                <label class="form-label">Title (Ar): <span class="tx-danger">*</span></label>
                                {!! Form::text('sub_title[${i}][1]',old('sub_title.${i}.1'),['class' =>'form-control '.($errors->has('sub_title.${i}.1') ? 'parsley-error' : null),'placeholder'=> 'Enter Title']) !!}
                                @error('sub_title.${i}.1')
                                    <ul class="parsley-errors-list filled" id="parsley-id-11">
                                        <li class="parsley-required">
                                            {{$message}}
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 mt-3">
                            <div class="form-group mg-b-0">
                                <label class="form-label">Description (Ar): <span class="tx-danger">*</span></label>
                                {!! Form::textarea('sub_description[${i}][1]',old('sub_description.${i}.1'),['class' =>'form-control summernote '.($errors->has('description.${i}.1') ? 'parsley-error' : null),'placeholder'=> 'Enter Description']) !!}
