...
@section('page-header')
    @include('admin.dashboard.layouts.includes.index_statistics',['title'=>'Pages'])
@stop
@section('content')
            ...
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="create_import">
                            <a href="{{route('dashboard.pages.create')}}" class="btn  pd-x-20 mg-t-10">
                                <i class="icon-plus-circle"></i> Add Page
                            </a>
                        </div>
                        @endcan
                    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="zoom-container zoom-abs">
                        ...
                        <table id="pagesTable" class="table custom-table resizable">
                            <input type="hidden" name="status_id_search" id="status_id_search">
                            <thead>
                            <tr>
...
@section('js')
    ...
    @include('admin.dashboard.setting.pages.datatable')
...
function resizableGrid(table) {
  ...
  function setListeners(div) {
    ...
    div.addEventListener('mousedown', function(e) {
      ...
      tableWidth = document.getElementById('pagesTable').offsetWidth;
    ...
    document.addEventListener('mousemove', function(e) {
      if (curCol) {
        ...
        document.getElementById('pagesTable').style.width = tableWidth + diffX + "px"
      }
    });
