    ...
    <div class="row row-sm">
        <div class="col-xl-12">
            <div class="card mg-b-20">
                ...
                <div class="card-body">
                    {!! Form::model($article,['route' => ['dashboard.articles.update', $article->id],'method'=>'put','data-parsley-validate'=>'','id'=>'sub_brand_form','class'=>'create_page', 'enctype'=>'multipart/form-data']) !!}
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 mt-3">
                            <div class="form-group mg-b-0">
                                ...
                                {!! Form::textarea('sub_description[${i}][0]',old('sub_description.${i}.0')??NULL,['class' =>'form-control summernote '.($errors->has('sub_description.${i}.0') ? 'parsley-error' : null),'placeholder'=> 'Enter Description']) !!}
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 mt-3">
                            <div class="form-group mg-b-0">
                                ...
                                {!! Form::textarea('sub_description[${i}][1]',old('sub_description.${i}.1')??NULL,['class' =>'form-control summernote '.($errors->has('sub_description.${i}.1') ? 'parsley-error' : null),'placeholder'=> 'Enter Description']) !!}
        ...
        function delete_section(id){
            Swal.fire({
                ...
                if (result.isConfirmed){
                    $.ajax({
                        url: "{{ route('dashboard.articles.sections.delete','') }}"+"/"+id,
                        type:'delete',
                        method:'delete',
