...
@section('page-header')
    @include('admin.dashboard.layouts.includes.index_statistics',['title'=>'Comments'])
@stop
@section('content')
            ...
            <div class="card mg-b-20">
                ...
                <div class="card-body">
                    ...
                    <div class="zoom-container zoom-abs">
                        ...
                        <table id="commentsTable" class="table custom-table resizable">
                            <thead>
                            <tr>
...
@section('js')
    ...
    @include('admin.dashboard.setting.articles.comments.datatable')
...
function resizableGrid(table) {
  ...
  function setListeners(div) {
    ...
    div.addEventListener('mousedown', function(e) {
      ...
      tableWidth = document.getElementById('commentsTable').offsetWidth;
    ...
    document.addEventListener('mousemove', function(e) {
      if (curCol) {
        ...
        document.getElementById('commentsTable').style.width = tableWidth + diffX + "px"
      }
    });
