...
@section('page-header')
    @php
        $routes =  [
            ['route'=>route('dashboard.statistics.index'),'name'=>'statistics']
        ];
    @endphp
    ...
    <div class="row row-sm">
        <div class="col-xl-12">
            <div class="card mg-b-20">
                ...
                <div class="card-body">
                    {!! Form::model($statistic,['route' => ['dashboard.statistics.update', $statistic->id],'method'=>'put','data-parsley-validate'=>'','id'=>'sub_brand_form','class'=>'create_page','files'=>true]) !!}
