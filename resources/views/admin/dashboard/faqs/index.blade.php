            ...
            <div class="card mg-b-20">
                ...
                <div class="card-header pb-0">
                    <button onclick="toggle_form()" class="btn pd-x-20 mg-t-10">
                        <i class="icon-plus-circle"></i> Create FAQ
                    </button>
                </div>
                @endcan
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        ...
                        <table id="faqsTable" class="table custom-table resizable">
                            <thead>
                                <tr>
                                    <th>#</th>
...
@section('js')
    <script src="https://cdn.jsdelivr.net/npm/summernote@0.8.18/dist/summernote.min.js"></script>
        ...
        @include('admin.dashboard.faqs.datatable')
        @if ($errors->any())
            <script>
            $('.create_faq').toggle();
            </script>
        ...
        @elseif(session()->has('error_message'))
            <script>
                Swal.fire("Error!", "{{session()->get('error_message')}}", "error");
            </script>
        @endif
        <script>
        ...
        function setListeners(div) {
            ...
            tableWidth = document.getElementById('faqsTable').offsetWidth;
            ...
            if (curCol) {
                ...
                document.getElementById('faqsTable').style.width = tableWidth + diffX + "px"
            }
            });
