    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
                    ...
                    <div class="row">
                        <div class="col-12">
                            @if($campaign->campaign_type==0||$campaign->campaign_type==2)
                                ...
                                <small class="text-danger mb-2" id="err_visit_confirm"></small><br>
                                ...
                                <small class="text-danger mb-2" id="err_visit_confirm_link"></small><br>
            ...
            <div class="modal-footer">
                <button type="button" id="update_coverage_done" class="btn Active hvr-sweep-to-right">Save</button>
