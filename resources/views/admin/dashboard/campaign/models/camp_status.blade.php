    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" id="action_camp_status" class="btn Active hvr-sweep-to-right">Save</button>
                <button type="button" class="btn Delete hvr-sweep-to-right" id="closeModal"
